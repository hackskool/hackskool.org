    ...
    <Layout>
        ...
        <div className={"container"}>
            <div className={"content"}>
                ...
                <p>1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (<strong>you</strong>), and <strong>HackSkool</strong>, doing business as<strong> HackSkool</strong> <strong>(https://histaff.io) </strong>website as well as any related applications (the <strong>Site</strong>). &nbsp;</p>
